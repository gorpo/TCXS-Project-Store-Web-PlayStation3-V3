...
if (!empty($_POST)) {
    ...
    if ($validacao) {
        ...
        $sql = "UPDATE playstation_ps2  set titulo=:titulo, descricao=:descricao, content_id=:content_id, imagem=:imagem, cadastro=now() , link=:link  WHERE id=:id";
        $q = $pdo->prepare($sql);
...
<head>
    <meta charset="UTF-8">
      ...
      <title>TCXS Project | UPDATE PS2 GAME</title>
</head>
<body>
<div class="container">
...
<div class="barraBase">
  <div class="blocoDadosInputs">
    <h3 class="tituloRed">[WARNING]<br>Atualizar: <?php echo $data['titulo']; ?><br>PlayStation PS2<br>Data Cadastro: <?php echo $data['cadastro']; ?> </h3>
