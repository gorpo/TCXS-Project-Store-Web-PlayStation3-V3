...
<head>
    <meta charset="UTF-8">
      ...
      <title>TCXS Project | EXTRAS INFO</title>
</head>
<body>
<div class="container">
    ...
    <caption>
          ...
          <div class="barraBase">
            <div class="blocoDadosInputs">
             <h3 class="tituloRed">[INFORMAÇÕES - APENAS LEITURA]<br>Jogo: <?php echo $data['titulo']; ?><br>PlayStation Extras<br>Data Cadastro: <?php echo $data['cadastro']; ?> </h3>
        <form class="form-horizontal">
          ...
          <div class="wrap-input100 validate-input m-b-16" >
            <div class="control-group  <?php echo !empty($tituloErro) ? 'error ' : ''; ?>">
            <label class="titulo">CONTENT ID EXTRAS </label>
                <div class="controls">
          ...
          <div class="wrap-input100 validate-input m-b-16" >
            <div class="control-group  <?php echo !empty($tituloErro) ? 'error ' : ''; ?>">
            <label class="titulo">DATA EXTRAS </label>
                <div class="controls">
          ...
          <div class="wrap-input100 validate-input m-b-16" >
            <div class="control-group  <?php echo !empty($tituloErro) ? 'error ' : ''; ?>">
            <label class="titulo">Link EXTRAS </label>
                <div class="controls">
