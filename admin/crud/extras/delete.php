...
if(!empty($_POST))
{
    ...
    $sql = "DELETE FROM playstation_extras where id = ?";
    $q = $pdo->prepare($sql);
    $q->execute(array($id));
    ...
    <caption>
        ...
        <form class="form-horizontal" action="delete.php" method="post"  autocomplete="off">
          ...
          <div class="wrap-input100 validate-input m-b-16" >
            ...
            <label class="titulo">Excluir o extra?</label>
                <div class="controls">
            ...
            <span class="focus-input100"></span></div></div></div>
                    ...
                    <div class="form actions">
                        <button type="submit" class="login100-form-btn m-b-16">Sim quero excluir o extra <?php echo $data['titulo']; ?></button>
                        <a href="index.php" type="btn" class="login100-form-btn m-b-16">Não quero excluir o extra...</a>
                    </div>
                </form>
