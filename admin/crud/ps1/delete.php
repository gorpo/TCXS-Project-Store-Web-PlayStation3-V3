...
if(!empty($_POST))
{
    ...
    $sql = "DELETE FROM playstation_ps1 where id = ?";
    $q = $pdo->prepare($sql);
    $q->execute(array($id));
...
<head>
    <meta charset="UTF-8">
      ...
      <title>TCXS Project | DELETE PS1 GAME</title>
</head>
<body>
<div class="container">
...
<!-- ============= MENUS PARA PC E CELULAR ======== --->
    <caption>
          ...
          <div class="barraBase">
            ...
            <h3 class="tituloRed">[WARNING]<br>Deletar: <?php echo $data['titulo']; ?><br>PlayStation PS1<br>Data Cadastro: <?php echo $data['cadastro']; ?> </h3>
