...
<div class="container">
        ...
        <table>
          <caption>
            ...
            <a href="create.php" type="btn" class="login100-form-btn m-b-16">ADICIONAR JOGO PS1</a>
          </caption>
        ...
        $sql = 'SELECT * FROM playstation_ps1 ORDER BY id DESC';
        ...
        foreach($pdo->query($sql)as $row)
        {
          ...
          if(isset(explode("/", $row['link'])[5])){
            ...
            echo '<td data-label="Imagem">'.'<a class="linkCrud" href="../../../assets/images/ps1/'.$row['imagem'].'">'. $row['imagem'] . '</a></td>';
