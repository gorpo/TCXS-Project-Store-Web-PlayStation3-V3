...
//Inserindo no database:
    if ($validacao) {
        ...
        $sql = "INSERT INTO playstation_ps1  (titulo, descricao, content_id, imagem,cadastro, link) VALUES(?,?,?,?,NOW(),? )";
        $q = $pdo->prepare($sql);
...
<head>
    <meta charset="UTF-8">
      ...
      <title>TCXS Project | ADD PS1 GAME</title>
</head>
<body>
<div class="container">
